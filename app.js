...
const getFollowingPeopleIdsOfUser = async username => {
  const getTheFollowingPeopleQuery = `
        ...
        INNER JOIN user ON user.user_id = follower_user_id
...
app.get('/user/follwoing/', authentication, async (request, response) => {
...
app.get('/user/follwers/', authentication, async (request, response) => {
  const {username, userId} = request
...
FROM tweet LEFT JOIN reply ON tweet.tweet_id = reply.tweet_id LEFT JOIN like ON tweet.tweet_id = reply.tweet_id
